...
<template>
  <view :id="'ChartBoxId' + cid" class="chartsview">
    <view v-if="mixinDatacomLoading">
      <!-- 自定义加载状态，请改这里 -->
      <QiunLoading :loading-type="loadingType" />
    </view>
    <view v-if="mixinDatacomErrorMessage && errorShow" @tap="reloading">
      <!-- 自定义错误提示，请改这里 -->
      <QiunError :error-message="errorMessage" />
    </view>
...
<script>
import uChartsMp from '../../biz/u-charts/u-charts.js';
import cfu from '../../biz/u-charts/config-ucharts.js';

// #ifdef APP-VUE || H5
import cfe from '../../biz/u-charts/config-echarts.js';
// #endif
...
import cfe from '../../biz/u-charts/config-echarts.js';
import cfu from '../../biz/u-charts/config-ucharts.js';
import uChartsRD from '../../biz/u-charts/u-charts.js';
  ...
  methods: {
    ...
    ecinit(newVal, oldVal, owner, instance){
      ...
      if (typeof window.echarts === 'object') {
        ...
        script.src = rooturl + directory + 'campus/green-campus/utils/h5/echarts.min.js'
        // #endif
