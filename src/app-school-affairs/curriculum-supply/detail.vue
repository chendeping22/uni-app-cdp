          ...
          <view class="plr-l ptb-b">
            <view class="bg-white radius-default plr-l ptb-b">
              ...
              <view class="supply-wrapper mt-b">
                ...
                <template v-for="(item, index) in detail.agentInfoList" :key="item.id">
                  <u-gap height="24" />
                  <view class="flex-center">
                    <view class="alternative-index no-shrink mr-b">{{ index + 1 }}</view>
                    <view class="flex-stretch scroll-hidden">
                      <view class="course-text">
                        第{{ item.sourceSectionNo }}节-{{ item.sourceSubjectName }}
                      </view>
                      <view class="mt-xxs flex-between">
                        <view class="class-text">
                          {{ item.sourceClazzDate }}({{ weekText[item.sourceDayOfWeek] }})
                        </view>
                        <view class="class-text class2-text text-ellipse">
                          {{ item.sourceClazzName }}
                        </view>
                      </view>
                    </view>
                  </view>
            ...
            <view v-if="detail.approveUserId" class="bg-white radius-default plr-l ptb-b mt-b">
              <view class="card-title">代课意见</view>
              <view class="detail-item mt-b">
              ...
              <view class="detail-item mt-s">
                <view class="detail-label">代课意见</view>
                <view class="detail-text">
