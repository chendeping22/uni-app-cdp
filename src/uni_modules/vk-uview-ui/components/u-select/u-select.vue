<template>
  <view class="u-select">
    ...
    <u-popup
      ...
      @close="close"
    >
      <view class="u-select" style="border-radius: 30rpx">
        <view class="u-select__header" @touchmove.stop.prevent="">
          ...
          <view class="u-select__header__title" style="font-weight: bold">
            {{ title }}
          </view>
          <view
    ...
    columnChange(e) {
      ...
      if (this.mode == 'mutil-column-auto') {
        ...
        for (let i = index + 1; i < this.columnNum; i++) {
          ...
          // 默认是队列的第一个为默认选项
          this.columnData[i] =
            this.columnData[i - 1][i - 1 == index ? columnIndex[index] : 0][this.childName];
          // 改变的列之后的所有列，默认选中第一个
