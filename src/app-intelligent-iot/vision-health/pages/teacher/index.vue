...
import VisionProgress from './components/vision-progress.vue';
import VisionRingCharts from './components/vision-ring-charts.vue';
import VisionTable from './components/vision-table.vue';
...
const rowClick = data => {
  uni.navigateTo({
    url: `/app-intelligent-iot/vision-health/pages/teacher/class?bizid=${data.classId}&className=${data.className}&workId=${pageData.optionData.workId}&type=3&locationId=${pageData.optionData.locationId}`,
  });
};
onLoad(option => {
  // type=XXX&bizid=XXXX
