<template>
  <div>
      <c-head> 
        ...
        <p slot='center' class='user-title'>关注学校</p>   
      </c-head> 
        <div> 
            <tab :line-width="1" custom-bar-width="0"  @on-before-index-change="switchTabItem">
                <tab-item selected >全部</tab-item>
                <tab-item  class="vux-1px-l">学校</tab-item>
                <tab-item class="vux-1px-l">机构</tab-item>
                <tab-item class="vux-1px-l">俱乐部</tab-item>
            </tab> 
        </div>
        <div> 
...
export default {
  ...
  data(){
    return {
         list: [{
        src: '/static/img_institutions03.png',
        fallbackSrc: 'http://placeholder.qiniudn.com/60x60/3cc51f/ffffff',
        title: '西瓜幼儿园',
        desc: '简介：建筑面积100百万平方米，有独立游泳池',
        url: '/component/cell', 
      }, {
        src: '/static/img_institutions03.png',
        fallbackSrc: 'http://placeholder.qiniudn.com/60x60/3cc51f/ffffff',
