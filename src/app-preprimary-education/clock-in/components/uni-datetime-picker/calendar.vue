...
.uni-calendar__header-btn {
  width: 9px;
  height: 9px;
  border-left-color: $ui-color-line-strong;
  border-left-style: solid;
  border-left-width: 1px;
  border-top-color: $ui-color-line-strong;
  border-top-style: solid;
  border-top-width: 1px;
}
...
.uni-calendar__weeks-day {
  ...
  align-items: center;
  height: 40px;
  border-bottom-color: $ui-color-line-light;
...
.uni-date-changed {
  ...
  text-align: center;
  color: $ui-color-placeholder;
  border-top-color: $ui-color-placeholder;
  border-top-style: solid;
  border-top-width: 1px;
  flex: 1;
}
...
.dialog-close-plus {
  width: 16px;
  height: 2px;
  background-color: $ui-color-line-strong;
  border-radius: 2px;
  transform: rotate(45deg);
}
