  ...
  <view class="uni-datetime-picker">
    ...
    >
      ...
      <view v-if="timeShow" class="uni-datetime-picker__container-box">
        ...
        <!-- 兼容 nvue 不支持伪类 -->
        <text class="uni-datetime-picker-sign" :class="[hideSecond ? 'sign-center' : 'sign-left']"
          >:</text
        >
...
export default {
  ...
  computed: {
    ...
    currentDateIsStart() {
      return (
        this.year === this.startYear && this.month === this.startMonth && this.day === this.startDay
      );
    },
  ...
  methods: {
    ...
    createDomSting() {
      const yymmdd =
        this.year + '-' + this.lessThanTen(this.month) + '-' + this.lessThanTen(this.day);
