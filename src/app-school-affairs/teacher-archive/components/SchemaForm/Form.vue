...
import type { Field, FieldsGroup, InputTextField, SelectField } from '../../types/schema.ts';
// import type { FormInstance } from 'ant-design-vue';
import AreaSelect from '@/app-school-affairs/components/area-select/selector.vue';
