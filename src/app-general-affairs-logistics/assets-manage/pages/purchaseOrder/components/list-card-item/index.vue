<template>
  <view class="list-card-item">
    ...
    <view
      ...
      <view v-if="isCollapse && showContentEllipsis" class="btn" @click.stop="handleMore">
        <!-- <view class="more-note">…</view> -->
        <view class="more-txt">更多</view></view
      >
      <text v-if="!isCollapse && showContentEllipsis" class="more-btn" @click.stop="handleClose"
        >收起</text
      ></view
    >
  </view>
